...
export function Card(props: ICardProps) {
  ...
  const preset: TPresets = props.preset ?? "default"
  ...
  const $headingStyle = [
    ...
    (isFooterPresent || isContentPresent) && { marginBottom: spacing.s1 },
    $headingStyleOverride,
    HeadingTextProps?.style,
  ]
  const $contentStyle = [
    $contentPresets[preset],
    isHeadingPresent && { marginTop: spacing.s1 },
    isFooterPresent && { marginBottom: spacing.s1 },
    $contentStyleOverride,
    ContentTextProps?.style,
  ]
  const $footerStyle = [
    $footerPresets[preset],
    (isHeadingPresent || isContentPresent) && { marginTop: spacing.s1 },
    $footerStyleOverride,
  ...
  const $alignmentWrapperStyle = [
    ...
    LeftComponent && { marginStart: spacing.s5 },
    RightComponent && { marginEnd: spacing.s5 },
  ]
